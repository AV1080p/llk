...
class sfp_subdomainbing(SpiderFootPlugin):
    """SubDomainBing:Footprint,Investigate,Passive:Search Engines:errorprone:Some light Bing scraping to identify sub-domains."""
