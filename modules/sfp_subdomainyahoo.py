...
class sfp_subdomainyahoo(SpiderFootPlugin):
    """SubDomainYahoo:Footprint,Investigate,Passive:Search Engines:errorprone:Some light Yahoo scraping to identify sub-domains"""
    ...
    def producedEvents(self):
        return ["YAHOO_SUBDOMAIN", "YAHOO_URL"]
        ...
        for page in pages.keys():
            ...
            for link in links:
                ...
                if self.sf.urlFQDN(link).endswith(eventData):
                    ...
                    evt = SpiderFootEvent("YAHOO_SUBDOMAIN", link,
                                          self.__name__, event)
